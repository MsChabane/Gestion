...
public class ArticlesViews extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabArticles.setFont(new java.awt.Font("Serif", 0, 18)); // NOI18N
        ...
        tabArticles.setDropMode(javax.swing.DropMode.ON);
        tabArticles.setEditingColumn(6);
        tabArticles.setEditingRow(5);
        tabArticles.setFocusable(false);
        tabArticles.setGridColor(new java.awt.Color(153, 153, 153));
        tabArticles.setRowHeight(40);
        tabArticles.setRowMargin(1);
        tabArticles.setRowSelectionAllowed(false);
        tabArticles.setSelectionBackground(new java.awt.Color(0, 153, 255));
        tabArticles.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        tabArticles.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_INTERVAL_SELECTION);
        tabArticles.setShowGrid(true);
        tabArticles.setUpdateSelectionOnSort(false);
        ...
        btnModifier.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_update_left_rotation_32px.png"))); // NOI18N
        ...
        btnAjouter.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8_add_32px_1.png"))); // NOI18N
